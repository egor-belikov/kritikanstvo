...
if($id!= null & $url != null)
{
	$link = "http://gamestar.ru/articles/reviews/";
	$page=file_get_contents($link);
  	// $page = mb_convert_encoding($page, "UTF-8", "windows-1251");
	$content_html = SelectNode($page, "div", "class=\"article\"");

	$items = SelectNodes($content_html, "div", "class=\"item");
	foreach ($items as $item)
	{
		$url_div = SelectNode($item, "div", "class=\"title\"");
		$new_url = 'http://gamestar.ru'.SelectiSubs($url_div, "href=\"", "\"");
