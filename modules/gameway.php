...
if($id!= null & $url != null)
{
	$link = 'http://gameway.com.ua/category/recensiyi';
	$page=file_get_contents($link);
  	// $page = mb_convert_encoding($page, "UTF-8", "windows-1251");
	$content_html = SelectNode($page, 'div', 'id="archive-wrapper"');
	...
	", '&#8212;', '&mdash;', '&quot;'),array('', '', ' ', '', '—', '—', '"'),strip_tags($url_div))));
			...
			if (mb_strstr($new_text,' — обзор игры'))
				$new_text=mb_strstr($new_text,' — обзор игры',true);
