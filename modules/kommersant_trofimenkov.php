...
if($id!= null & $url != null)
{
	$link = "http://kommersant.ru/authors/136";
	...
	{
		$url_div = SelectNode(SelectNode($item, "div", "class=\"mainpage_doc\""), "div", "class=\"title\"");
...
", '&#8212;', '&mdash;', '&quot;', '&#8217;',
			''),array('', '', ' ', '', '—', '—', '"', "'",
			''),strip_tags(SelectNode($url_div,'a').': '.SelectNode(SelectNode($item, "div", "class=\"mainpage_doc\""), "div", "class=\"subtitle\""),'a'))));
