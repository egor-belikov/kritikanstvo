...
if($id!= null & $url != null)
{
	$link = 'http://www.gameru.net/?act=arts&artpage=1&#article';
	$page=file_get_contents($link);
  	// $page = mb_convert_encoding($page, "UTF-8", "windows-1251");
	$content_html = between($page, '<a name="article"></a>', '<div class="clear">');
	$items = SelectNodes($content_html, 'table');
	foreach ($items as $item)
	{
		...
		if ($new_url!='')
		{
			$new_url='http://www.gameru.net'.$new_url;
